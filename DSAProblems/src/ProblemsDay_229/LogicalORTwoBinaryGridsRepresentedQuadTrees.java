...
class Node {
    ...
    public Node(boolean b, boolean val) {
    }
};
public class LogicalORTwoBinaryGridsRepresentedQuadTrees {

//https://leetcode.com/problems/logical-or-of-two-binary-grids-represented-as-quad-trees/?envType=problem-list-v2&envId=tree
    public Node intersect(Node quadTree1, Node quadTree2) {
        ...
        if (quadTree1.topLeft.isLeaf && quadTree1.topRight.isLeaf
            ...
            return new Node(true,quadTree1.topLeft.val);
        }
        return quadTree1;
    }
